  ...
  <div class="box">
    ...
    <div class="content">
      <div class="vtabs"><a href="#tab-order"><?php echo $tab_order; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a>
        ...
        <?php } ?>
        <a href="#tab-product"><?php echo $tab_product; ?></a><a href="#tab-history"><?php echo "History"; ?></a></div>
      ...
      <div id="tab-payment" class="vtabs-content">
        <table class="form">
          ...
          <?php if(isset($card_name) && $card_name != '') { ?>
          <tr>
...
$('#history').load('index.php?route=sale/orderCC/history&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');
